...
router.get("/withdrawals", isAdmin, cashMovementController.getAllWithdrawals)
router.get("/withdrawals/summary", isAdmin, cashMovementController.getWithdrawalsSummary)
